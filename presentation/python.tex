...
%    \pythonCode
    Slide codes at: 
    \href{https://gitlab.unige.ch/Thibaut.Lunet/python-math/tree/master/presentation/code_examples}{python-math/presentation/code\_examples.py}
...
%    \pythonCode\vspace{-20pt}
    ...
    \includegraphics[height=20pt]{lists.png}
...
\begin{frame}{Basic structures}
    ...
    \vspace{-5pt}
%    \pythonCode
    \includegraphics[width=0.9\linewidth]{code-struct}
